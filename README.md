...
The card uses [Button Card Configuration Templates](https://github.com/custom-cards/button-card#configuration-templates) reduce code repetition and make maintenance and changes easier.
